...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source termaksTM - اهلا بك في سورس ديف تيرماكس ~"
...
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (ABS) @IXIXA.|"
echo -e "|  This Is The Source Channel @termakstm .   |"
echo -e "|               - termaksTM -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
